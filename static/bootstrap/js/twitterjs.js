...
;(function($) {
    ...
    $.fn.twitterSearch.defaults = {
        ...
        animOutSpeed: 200,			// speed of animation for top tweet when removed
        animInSpeed: 200,			// speed of scroll animation for moving tweets up
        ...
        timeout: 4000,				// delay between tweet scroll
        ...
        css: {
            ...
            container: { overflow: 'hidden', backgroundColor: '#eee', height: '500' },
            ...
            frame: { border: '5px solid  #006dcc', borderRadius: '10px', '-moz-border-radius': '10px', '-webkit-border-radius': '10px' },
            tweet: { padding: '5px 10px', clear: 'left' },
            img:   { 'float': 'left', margin: '5px', width: '48px', height: '48px' },
            loading: { padding: '20px', textAlign: 'center', color: '#888' },
            text:  {},
            time:  { fontSize: 'smaller', color: '#888' },
            title: { color:'#ffffff', backgroundColor: '#006dcc', margin: 0, padding: '0 0 5px 0', textAlign: 'center', fontWeight: 'bold', fontSize: 'large', position: 'relative' },
