var w = 1280,
    ...
    nodes = d3.range(10).map(function() {
        return {radius: Math.random()*30 + 50}; }); // sets the number of nodes (circles in this case)
...
d3.json("/static/news/new_feed.json", function(news){
